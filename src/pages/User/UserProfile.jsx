...
const UserProfile = () => {
  ...
  return (
    <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="relative z-20 h-80 md:h-52">
        <img
          src="https://png.pngtree.com/thumb_back/fh260/background/20230611/pngtree-legal-documents-of-an-attorney-for-an-international-client-image_2961501.jpg"
          alt="profile cover"
        ...
        <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
          <label
            htmlFor="cover"
            className="flex cursor-pointer bg-black/70 border border-white/50 backdrop-blur items-center justify-center gap-2 rounded-md bg-primary py-1 px-2 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4"
          >
      ...
      <div className="px-4 pb-6 -mt-24 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-30 w-fit mx-auto p-0">
          <div className="relative drop-shadow-2 bg-white/20 backdrop-blur mx-auto w-48 aspect-square p-1 rounded-full overflow-hidden">
            <img
            ...
            <label
              htmlFor="profile"
              className="absolute p-2 bg-black/70 border border-white/50 backdrop-blur bottom-0 right-32 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-7 sm:right-7"
            >
              <svg
                className="fill-current"
                width="14"
        ...
        <div className="mt-4">
          <h3 className="mb-1.5 flex items-center justify-center gap-2 capitalize text-2xl font-semibold text-black dark:text-white">
            {authUser.name} <VerifiedIcon />
          </h3>
          <p className="font-medium text-xs text-gray-500">
            Joined at 13 May 2023
          </p>
